...
```
cd existing_repo
git remote add origin https://gitlab.com/egarcc/portal/profile_backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/egarcc/portal/profile_backend/-/settings/integrations)
